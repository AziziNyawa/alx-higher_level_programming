...
This module is made up ofclass that defines a Rectangle
...
class Rectangle:
    ...
    def area(self):
        """ Method that calculation of the the Rectangle area
    ...
    def __repr__(self):
        """ Method that returns the str represantion of the instance
