...
This module contains an algo that resolves the N-Queen puzzle
backtracking design
...
def isSafe(m_queen, nqueen):
    """ Method that determine if the queens can or can not kill each other

    Arguments:
        m_queen: array that has the queens pos
        nqueen: queen number

    Returns:
        True: when queens cannot kill each other
...
def print_result(m_queen, nqueen):
    """ Method that print the list with the queens pos
...
def Queen(m_queen, nqueen):
    """ Recursive function that executes the backtracking algo
...
def solveNQueen(size):
    """ Function that invokes the backtracking algo
