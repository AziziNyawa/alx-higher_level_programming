...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        """ initializing the square class with this
        Arguments:
            size: a side of square
            position: where the square is (coordinates) located
        """
        self.size = size
    ...
    def position(self, value):
        ...
        Arguments:
            value: where
        Raises:
                TypeError: if not tuple, integers, positive
        Returns: the pos
        """
